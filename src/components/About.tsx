...
const expertise = [
  { icon: "🔒", title: "Seguridad Informática",      desc: "Maestría en Ciberseguridad, certificación SAP ABAP, Symantec NetBackup, hardening y auditorías de seguridad.", accent: "rgba(239,68,68,0.12)",    border: "rgba(239,68,68,0.22)" },
  { icon: "🖥️", title: "DevOps & Infraestructura",   desc: "Linux (RedHat, Ubuntu, Suse), VMware vCenter, Docker, CI/CD pipelines, Windows Server, Oracle Linux.",         accent: "rgba(249,115,22,0.12)", border: "rgba(249,115,22,0.22)" },
  { icon: "⚛️", title: "Frontend – React / Next.js", desc: "Aplicaciones SPA y SSR modernas con React, Next.js, TypeScript y Tailwind CSS.",                               accent: "rgba(6,182,212,0.12)",  border: "rgba(6,182,212,0.22)" },
  { icon: "🛠️", title: "Backend – Laravel / FastAPI", desc: "APIs REST y microservicios con Laravel (PHP) y FastAPI (Python). PostgreSQL, MySQL, Oracle.",                 accent: "rgba(16,185,129,0.12)", border: "rgba(16,185,129,0.22)" },
  { icon: "🤖", title: "IA & Machine Learning",       desc: "Integración de Gemini AI, Computer Vision para reconocimiento de imágenes, LLMs y automatización inteligente.", accent: "rgba(59,130,246,0.14)", border: "rgba(59,130,246,0.28)" },
  { icon: "📱", title: "Desarrollo Mobile",            desc: "Apps Android nativas con Kotlin y multiplataforma con React Native, integradas a sistemas empresariales.",     accent: "rgba(139,92,246,0.12)", border: "rgba(139,92,246,0.22)" },
  { icon: "☁️", title: "Cloud & ERP",                  desc: "AWS, Azure, SAP-POS en 29 sucursales, SAP-R3 interfaces/IDOCS, WMS-KNAPP, AS400.",                           accent: "rgba(245,158,11,0.12)", border: "rgba(245,158,11,0.22)" },
];
