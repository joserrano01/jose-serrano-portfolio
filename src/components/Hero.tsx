      ...
      <div className="relative z-10 max-w-4xl mx-auto px-6 text-center">
        ...
        <div className="flex flex-wrap justify-center gap-2 mb-10">
          {techStack.map((t, i) => (
            <span
              key={t.name}
              className={`inline-flex items-center px-3 py-1 rounded-full text-xs font-medium border transition-all duration-200 hover:scale-110 hover:shadow-md cursor-default ${t.color}`}
